...
## 9. Planejamento tributário e impacto fiscal (Simples Nacional)

A operação da startup é estruturada sob o regime do Simples Nacional, permitindo recolhimento unificado de tributos por meio do DAS (Documento de Arrecadação do Simples Nacional). A receita é gerada de forma híbrida:
- **Assinaturas SaaS e Instalação**: Enquadradas no **Anexo III (Serviços)**, com alíquota inicial nominal de **6,00%** para receitas até R$ 180.000,00 anuais.
- **Venda de Equipamentos (Hardware IoT)**: Enquadrada no **Anexo I (Comércio)**, com alíquota inicial nominal de **4,00%** para receitas até R$ 180.000,00 anuais.

### Projeção fiscal anualizada por base de clientes:
- **10 clientes**: Receita Bruta Anualizada de R$ 42.440,00. Imposto total de R$ 2.198,40 (Alíquota efetiva ponderada de **5,18%**).
- **30 clientes**: Receita Bruta Anualizada de R$ 127.320,00. Imposto total de R$ 6.595,20 (Alíquota efetiva ponderada de **5,18%**).
- **50 clientes**: Receita Bruta Anualizada de R$ 212.200,00. Entra na 2ª faixa do Simples Nacional. Alíquota efetiva de Comércio passa a 4,50% e a de Serviços passa a 6,79%. Imposto total anualizado de R$ 12.416,08 (Alíquota efetiva ponderada de **5,85%**).
- **100 clientes**: Receita Bruta Anualizada de R$ 424.400,00. Entra na 3ª faixa do Simples Nacional. Alíquota efetiva de Comércio passa a 6,23% e a de Serviços passa a 9,34%. Imposto total anualizado de R$ 34.227,56 (Alíquota efetiva ponderada de **8,06%**).

---

## 10. Plano de negócios e captação de clientes iniciais (Go-To-Market)

- **Meta de Clientes Iniciais**: Atingir **50 clientes ativos nos primeiros 12 meses** (Ano 1) operando nos cinturões verdes e polos de agricultura protegida do Estado de Goiás.
- **Canais de Distribuição e Aquisição**:
  1. **Parcerias Institucionais (B2B2C)**: Integração com programas de assistência técnica e difusão tecnológica do SENAR Goiás e Sebrae Goiás por meio dos sindicatos rurais.
  2. **Varejo Técnico Especializado**: Parceria com lojas de insumos para irrigação e hidroponia. A colaboração com a **VarejoIN** viabilizará vitrines tecnológicas demonstrativas nesses pontos físicos.
  3. **Provas de Conceito (PoC) de Campo**: Instalação de estufas-piloto na Faculdade SENAI FATESG e na Faculdade de Princípios Militares (FPM) para atestar a economia de água (estimada em até 30%) e servir de social proof.
  4. **Presença Digital**: Conteúdo demonstrativo de setup e monitoramento no YouTube e no portal institucional, atraindo tráfego orgânico para o SaaS.
